...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorTextView = (TextView) findViewById(R.id.tv_error_loading_message);
        // TODO DONE (17) Find the ProgressBar using findViewById
        mProgressBar = (ProgressBar) findViewById(R.id.data_loading_bar);
    ...
    private void loadWeatherData() {
        // TODO DONE (20) Call showWeatherDataView before executing the AsyncTask
        showWeatherDataView();
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // TODO DONE (18) Within your AsyncTask, override the method onPreExecute and show the loading indicator
        ...
        protected void onPostExecute(String[] weatherData) {
            // TODO DONE (19) As soon as the data is finished loading, hide the loading indicator
